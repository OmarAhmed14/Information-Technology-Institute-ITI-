...
void LCD_voidConfigDirection()
{
	...
	DIO_voidSetPinDirection (LCD_CTRL_PORT,LCD_RS_PIN,OUTPUT_PIN);
	DIO_voidSetPinDirection (LCD_CTRL_PORT,LCD_RW_PIN,OUTPUT_PIN);
	DIO_voidSetPinDirection (LCD_CTRL_PORT,LCD_E_PIN,OUTPUT_PIN);
}
